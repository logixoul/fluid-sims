...
// std::hash specialization — defined without export (used only within this module)
namespace std {
...
static std::map<int, string> fmtMap = {
    { GL_R16F, "GL_R16F" },
    { GL_RGB16F, "GL_RGB16F" },
    { GL_RG32F, "GL_RG32F" },
    { GL_R32F, "GL_R32F" },
...
static std::map<int, int> fmtMapBpp = {
    { GL_R16F, 2 },
    { GL_R32F, 4 },
    { GL_RGB16F, 6 },
    { GL_RG32F, 8 },
...
static void setDefaults(gl::TextureRef tex) {
